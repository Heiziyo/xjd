...
<div class="floor" floor="<?php echo $this->_var['sort_order']; ?>" color="<?php echo $this->_var['ext_info']['cat_color']; ?>">
		<div class="floor-layout">
			<?php
	 		...
	 		?>
			<?php $_from = $this->_var['index_image3']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ad_0_09599300_1480055652');$this->_foreach['index_image'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['index_image']['total'] > 0):
    foreach ($_from AS $this->_var['ad_0_09599300_1480055652']):
        $this->_foreach['index_image']['iteration']++;
?>
			<a href="<?php echo $this->_var['ad_0_09599300_1480055652']['url']; ?>" target="_blank" class="banner-ad">
				<img src="<?php echo $this->_var['ad_0_09599300_1480055652']['image']; ?>" alt="" height="100" width="1210">
			</a>
                ...
                <div class="floor-content">
                	<div class="floor-left" style="border-top: 1px <?php echo $this->_var['ext_info']['cat_color']; ?> solid;">
                        ...
                        <div id="focus_<?php echo $this->_var['goods_cat']['id']; ?>" class="floor-banner">
                        	<ul>
                            <?php $_from = $this->_var['index_image']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ad_0_09627600_1480055652');$this->_foreach['index_image'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['index_image']['total'] > 0):
    foreach ($_from AS $this->_var['ad_0_09627600_1480055652']):
        $this->_foreach['index_image']['iteration']++;
?>
                            	<li>
                                	<a href="<?php echo $this->_var['ad_0_09627600_1480055652']['url']; ?>" target="_blank"><img data-original="<?php echo $this->_var['ad_0_09627600_1480055652']['image']; ?>" src="themes/68ecshopcom_360buy/images/loading.gif" width="270" height="475" /></a>
                                </li>
                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                            </ul>
                        </div>
						...
						<ul class="floor-words">
	    					...
	    					?>
							<?php $_from = $this->_var['child_cat_hot']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat_0_09634800_1480055652');$this->_foreach['name1'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['name1']['total'] > 0):
    foreach ($_from AS $this->_var['cat_0_09634800_1480055652']):
        $this->_foreach['name1']['iteration']++;
?>
							<?php $_from = $this->_var['cat_0_09634800_1480055652']['child']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat_child');$this->_foreach['name'] = array('total' => count($_from), 'iteration' => 0);
...
?>
                    ...
                    <div class="floor-right">
							...
							<div class="floor-tabs-panel" style="border-top: 1px <?php echo $this->_var['ext_info']['cat_color']; ?> solid;">
								...
								?>
								<?php $_from = $this->_var['best_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_09653000_1480055652');$this->_foreach['cat_item_goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['cat_item_goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_09653000_1480055652']):
        $this->_foreach['cat_item_goods']['iteration']++;
?>
								<div class="goods" id="li_<?php echo $this->_var['goods_0_09653000_1480055652']['id']; ?>" <?php if ($this->_foreach['cat_item_goods']['iteration'] % 4 == 0): ?>style="width: 234px"<?php endif; ?>>
									<div class="wrap">
										<a target="_blank" href="<?php echo $this->_var['goods_0_09653000_1480055652']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods_0_09653000_1480055652']['name']); ?>">
											<img data-original="<?php echo $this->_var['goods_0_09653000_1480055652']['thumb']; ?>" src="themes/68ecshopcom_360buy/images/loading.gif" alt="<?php echo htmlspecialchars($this->_var['goods_0_09653000_1480055652']['name']); ?>" height="140" width="140" class="pic_img_<?php echo $this->_var['goods_0_09653000_1480055652']['id']; ?>">
										</a>
										<p class="title">
											<a target="_blank" href="<?php echo $this->_var['goods_0_09653000_1480055652']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods_0_09653000_1480055652']['name']); ?>"><?php echo $this->_var['goods_0_09653000_1480055652']['short_style_name']; ?></a>
										</p>
										<p class="price">
											<span>
												<?php if ($this->_var['goods_0_09653000_1480055652']['promote_price'] != ""): ?>
												<?php echo $this->_var['goods_0_09653000_1480055652']['promote_price']; ?>
												<?php else: ?>
												<?php echo $this->_var['goods_0_09653000_1480055652']['shop_price']; ?>
												<?php endif; ?>
											</span>
										</p>
										<a class="add-cart" onclick="addToCart(<?php echo $this->_var['goods_0_09653000_1480055652']['id']; ?>)" title="加入购物车"></a>
									</div>
								</div>
								<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
							</div>
...
?>
							...
							<div class="floor-tabs-panel floor-tabs-hide" style="border-top: 1px <?php echo $this->_var['ext_info']['cat_color']; ?> solid;">
								...
								<ul>
									...
									?>
									<?php $_from = $this->_var['new_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_09697900_1480055652');$this->_foreach['goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_09697900_1480055652']):
        $this->_foreach['goods']['iteration']++;
?>
									<div class="goods" id="li_<?php echo $this->_var['goods_0_09697900_1480055652']['id']; ?>" <?php if ($this->_foreach['goods']['iteration'] % 4 == 0): ?>style="width: 234px"<?php endif; ?>>
										<div class="wrap">
											<a target="_blank" href="<?php echo $this->_var['goods_0_09697900_1480055652']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods_0_09697900_1480055652']['name']); ?>">
												<img data-original="<?php echo $this->_var['goods_0_09697900_1480055652']['thumb']; ?>" src="themes/68ecshopcom_360buy/images/loading.gif" alt="<?php echo htmlspecialchars($this->_var['goods_0_09697900_1480055652']['name']); ?>" height="140" width="140" class="pic_img_<?php echo $this->_var['goods_0_09697900_1480055652']['id']; ?>">
											</a>
											<p class="title">
												<a target="_blank" href="<?php echo $this->_var['goods_0_09697900_1480055652']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods_0_09697900_1480055652']['name']); ?>"><?php echo $this->_var['goods_0_09697900_1480055652']['short_style_name']; ?></a>
											</p>
											<p class="price">
												<span class="j_CurPrice">
													<?php if ($this->_var['goods_0_09697900_1480055652']['promote_price'] != ""): ?>
													<?php echo $this->_var['goods_0_09697900_1480055652']['promote_price']; ?>
													<?php else: ?>
													<?php echo $this->_var['goods_0_09697900_1480055652']['shop_price']; ?>
													<?php endif; ?>
												</span>
											</p>
											<a class="add-cart" onclick="addToCart(<?php echo $this->_var['goods_0_09697900_1480055652']['id']; ?>)" title="加入购物车"></a>
										</div>
									</div>
									<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
								</ul>

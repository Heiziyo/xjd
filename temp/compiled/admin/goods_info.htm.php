								...
								<table width="400" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_21487200_1480062410');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_21487200_1480062410']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_21487200_1480062410']['name_p'] >= "a" && $this->_var['brand_list_0_21487200_1480062410']['name_p'] <= "g"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_21487200_1480062410']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_21487200_1480062410']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_21487200_1480062410']['name']; ?>')"><?php echo $this->_var['brand_list_0_21487200_1480062410']['name']; ?></a>
												</div>
											</div>
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_21500000_1480062410');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_21500000_1480062410']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_21500000_1480062410']['name_p'] >= "h" && $this->_var['brand_list_0_21500000_1480062410']['name_p'] <= "k"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_21500000_1480062410']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_21500000_1480062410']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_21500000_1480062410']['name']; ?>')"><?php echo $this->_var['brand_list_0_21500000_1480062410']['name']; ?></a>
												</div>
											</div>
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_21511700_1480062410');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_21511700_1480062410']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_21511700_1480062410']['name_p'] >= "l" && $this->_var['brand_list_0_21511700_1480062410']['name_p'] <= "s"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_21511700_1480062410']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_21511700_1480062410']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_21511700_1480062410']['name']; ?>')"><?php echo $this->_var['brand_list_0_21511700_1480062410']['name']; ?></a>
												</div>
											</div>
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_21524600_1480062410');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_21524600_1480062410']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_21524600_1480062410']['name_p'] >= "t" && $this->_var['brand_list_0_21524600_1480062410']['name_p'] <= "z"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_21524600_1480062410']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_21524600_1480062410']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_21524600_1480062410']['name']; ?>')"><?php echo $this->_var['brand_list_0_21524600_1480062410']['name']; ?></a>
												</div>
											</div>
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_21537500_1480062410');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_21537500_1480062410']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_21537500_1480062410']['name_p'] >= "0" && $this->_var['brand_list_0_21537500_1480062410']['name_p'] <= "9"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_21537500_1480062410']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_21537500_1480062410']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_21537500_1480062410']['name']; ?>')"><?php echo $this->_var['brand_list_0_21537500_1480062410']['name']; ?></a>
												</div>
											</div>

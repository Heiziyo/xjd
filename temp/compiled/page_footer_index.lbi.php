...
?>
          <dl class="col-article <?php if (($this->_foreach['no']['iteration'] <= 1)): ?>col-article-first<?php endif; ?>">
            ...
            <?php $_from = $this->_var['help_cat']['article']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item_0_19894200_1480055652');if (count($_from)):
    foreach ($_from AS $this->_var['item_0_19894200_1480055652']):
?>
            <dd><a rel="nofollow" href="help.php?id=<?php echo $this->_var['item_0_19894200_1480055652']['article_id']; ?>" target="_blank"><?php echo $this->_var['item_0_19894200_1480055652']['short_title']; ?></a></dd>
...
?>
        ...
        <p class="nav_bottom">
            ...
            <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_19918600_1480055652');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_19918600_1480055652']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
            <a href="<?php echo $this->_var['nav_0_19918600_1480055652']['url']; ?>"  <?php if ($this->_var['nav_0_19918600_1480055652']['opennew'] == 1): ?>target="_blank"<?php endif; ?>><?php echo $this->_var['nav_0_19918600_1480055652']['name']; ?></a><em <?php if (($this->_foreach['nav_bottom_list']['iteration'] == $this->_foreach['nav_bottom_list']['total'])): ?>style="display:none"<?php endif; ?>>|</em>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            <?php endif; ?>

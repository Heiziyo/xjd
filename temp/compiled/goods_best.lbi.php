    ...
    <div class="colList"> 
     <a id="btn-left1"  class="prev" title="上一个" onclick="top4()"></a>
      <div class="slider1 colFrame">
		<ul>
      	<?php $_from = $this->_var['best_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_23537200_1480059417');$this->_foreach['best_goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['best_goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_23537200_1480059417']):
        $this->_foreach['best_goods']['iteration']++;
?>
    		<li>
            	<div class="p-img"><a href="<?php echo $this->_var['goods_0_23537200_1480059417']['url']; ?>" title="<?php echo $this->_var['goods_0_23537200_1480059417']['name']; ?>"><img width="160" height="160" alt="<?php echo $this->_var['goods_0_23537200_1480059417']['name']; ?>"  src="<?php echo $this->_var['goods_0_23537200_1480059417']['thumb']; ?>"/></a></div>
                <div class="rain-product-info">
            	<div class="p-price"><strong class="best_goods_price"> 
              	<?php if ($this->_var['goods_0_23537200_1480059417']['promote_price'] != 0): ?> 
              	<?php echo $this->_var['goods_0_23537200_1480059417']['formated_promote_price']; ?> 
              	<?php else: ?> 
              	<?php echo $this->_var['goods_0_23537200_1480059417']['shop_price']; ?> 
              	<?php endif; ?> 
              	</strong>
                </div>
                <div class="rate"><a href="<?php echo $this->_var['goods_0_23537200_1480059417']['url']; ?>" title="<?php echo $this->_var['goods_0_23537200_1480059417']['name']; ?>"><?php echo sub_str($this->_var['goods_0_23537200_1480059417']['name'],12); ?></a></div>
                </div>
            </li>

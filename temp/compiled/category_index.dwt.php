...
?><a href="<?php echo $this->_var['ad']['url']; ?>" target="_blank"> <img src="themes/68ecshopcom_360buy/images/loading.gif" data-original="<?php echo $this->_var['ad']['image']; ?>"  height="187" width="510"></a><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
if ($this->_foreach['index_image']['total'] > 0):
    foreach ($_from AS $this->_var['ad']):
        $this->_foreach['index_image']['iteration']++;
?><a href="<?php echo $this->_var['ad']['url']; ?>" target="_blank"><img src="themes/68ecshopcom_360buy/images/loading.gif" data-original="<?php echo $this->_var['ad']['image']; ?>" height="187" width="340"></a><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
if ($this->_foreach['index_image']['total'] > 0):
    foreach ($_from AS $this->_var['ad']):
        $this->_foreach['index_image']['iteration']++;
?><a href="<?php echo $this->_var['ad']['url']; ?>" target="_blank" class="last"> <img src="themes/68ecshopcom_360buy/images/loading.gif" data-original="<?php echo $this->_var['ad']['image']; ?>"  height="187" width="340"></a><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> </div>
</div>
